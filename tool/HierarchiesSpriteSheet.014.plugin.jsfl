/*
 * Hierarchies Sprite Sheet Plug-in for CCHierarchiesSprite version 0.14
 *
 * author: bman <zx123xz321hm3@hotmail.com>
 *
 * version 0.1   11/13/2013
 */

function getPluginInfo(lang)
{
	pluginInfo = new Object();
	pluginInfo.id = "HierarchiesSpriteSheet_014";
	pluginInfo.name = "HierarchiesSpriteSheet_014";
	pluginInfo.ext = "sprites";
